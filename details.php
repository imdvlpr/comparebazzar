	...
	while ($row_product= mysqli_fetch_array($run_product)){
	 ...
	 echo"
		...
		<h2 style='text-align:center;'>$pro_title</h2>
		 ...
		 <img src='product_images/$pro_image1'alt='Demo image' id='field'>
		 <img src='product_images/$pro_image2'alt='Demo image' id='field' >
		 <img src='product_images/$pro_image3'alt='Demo image' id='field' >
		 </div>
	     <h2 style='text-align:right;'> RS $pro_price -/</h2>
		  <h3 style='text-align:center;'>$pro_desc</h3>
		 <h3 style='text-align:center;'>$pro_name</h3>
		 <h3 style='text-align:center;'>m.no $pro_num</h3>
		 
		  <h3 style='text-align:center;'>$pro_city</h3>
