...
<script type="text/javascript">
  <!--
  if (screen.width <= 800) {
    window.location = "http://comparebazzar.com/m_insert_product.php";
  }
  //-->
</script>

<link rel="stylesheet" href="style/style_uploadp.css" media="all" />
</head>

<body>
<div class="main_wrapper">

 <div class="header_wrapper" style="background-image:url(images/header1.jpg)">
  ...
  <button type="submit" class="btn btn-default">Submit</button>
    ...
    <li class="active"><a href="all_products.php"></span>All products</a></li>
 <li class="dropdown">
...
<!--cities and state-->	   
  ...
  <select class="form-control" name="product_cat">
   ...
   ?>             
	    ...
	    <!--brand start-->
	   <tr>
	   <td align="left"> <label for="sel1"><h4>Product Brands:</h4></label></td>
	   <td>
...
<!--cities and state-->	   
   ...
   ?>           
	...
	<div class="footer" style="background-image:url(images/footer2.gif); height:130px; width:980px;"></div>
